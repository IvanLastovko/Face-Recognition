...
class App extends Component {
  ...
  componentDidMount() {
    fetch('https://aqueous-river-73486.herokuapp.com')
  ...
  calculateFaceLocation = (data) => {
    ...
    for (let i = 0; i < faceCount; i++) {
      ...
      return {
        bottomRow, topRow, leftCol, rightCol
      }
    }
  }
  displayFaceBox = (box) => {
  ...
  onButtonSubmit = () => {
    ...
    fetch('https://aqueous-river-73486.herokuapp.com/imageurl', {
      method: 'post',
      ...
      .then(response => {
        if (response) {
          fetch('https://aqueous-river-73486.herokuapp.com/image', {
            method: 'put',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({
      ...
      .catch(err => console.log('No Faces Detected'))
  }
